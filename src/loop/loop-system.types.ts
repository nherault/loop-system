...
export type ComputeFct = (delta: number, extraArgs?: any) => void;
export type IsComputeFct = (computeElement: ComputeElement, delta: number) => boolean;
...
export interface LoopSystem {
    ...
    addCompute(
        ...
        compute: ((delta: number, extraArgs?: any) => void) | ComputeElement): LoopSystem;
